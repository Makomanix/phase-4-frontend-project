...
export default function UserLeaderboard() {
    ...
    return (
        <div className="bg-slate-200 absolute inset-x-0 bottom-8 left-80 mr-20 ml-20 h-auto rounded-md border-8 outline">
            <h1 className="text-center font-bold">Recent Time Trials</h1>
