...
export default function RecentTimes ({time_trial}) {
    ...
    return (
        <div className="grid grid-cols-4 grid-rows-1 w-auto h-8 bg-slate-400 mx-2 overflow-hidden rounded-xl outline hover:bg-slate-200" >
            ...
            <div className='text-center pr-4 pt-1'>{Lap_Time}</div>
    </div>
    )
}