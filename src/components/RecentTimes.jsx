...
export default function RecentTimes ({ time_trial }) {
    ...
    return (
        <div className="grid grid-cols-4 grid-rows-1 w-auto h-8 xl:h-12 bg-slate-400 mx-2 overflow-hidden rounded-xl outline hover:bg-indigo-600 hover:text-orange-500" >
