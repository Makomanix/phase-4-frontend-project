...
export default function UserProfile ({ user }) {
    ...
    return (
        <div className='absolute left-8 top-[15%] h- w-[60%]'>
            <div class="bg-slate-200 grid overflow-hidden xl grid-cols-1 grid-rows-5 gap-px gap-x-14 gap-y-.05 grid-flow-row w-1/2 h-58 px-2 border-4 outline rounded-lg">
